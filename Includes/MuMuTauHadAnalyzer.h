...
#ifndef MuMuTauHadAnalyzer_h
#define MuMuTauHadAnalyzer_h
...
class MuMuTauHadAnalyzer : public Histomutau {
public :
...
string MuMuTauHadAnalyzer::createOutputFileName()
{
...
MuMuTauHadAnalyzer::~MuMuTauHadAnalyzer()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MuMuTauHadAnalyzer::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MuMuTauHadAnalyzer::LoadTree(Long64_t entry)
{
...
Bool_t MuMuTauHadAnalyzer::Notify()
{
...
void MuMuTauHadAnalyzer::Show(Long64_t entry)
{
...
Int_t MuMuTauHadAnalyzer::Cut(Long64_t entry)
{
...
#endif // #ifdef MuMuTauHadAnalyzer_cxx
