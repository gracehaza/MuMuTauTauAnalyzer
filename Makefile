...
all: runMuMuAnalyzer runMuMuTauMuTauHadAnalyzer runMuMuTauMuTauMuAnalyzer runMuMuTauMuTauEAnalyzer runMuMuTauETauEAnalyzer runMuMuTauETauHadAnalyzer runMuMuTauHadTauHadAnalyzer runMuMuUndecayedTauETauEAnalyzer runMuMuUndecayedTauMuTauMuAnalyzer runMuTauFlatTreelizer runFakeMuMuTauMuTauHadAnalyzer runFakeMuMuTauMuTauMuAnalyzer runFakeMuMuTauMuTauEAnalyzer runFakeMuMuTauETauEAnalyzer runFakeMuMuTauETauHadAnalyzer runFakeMuMuTauHadTauHadAnalyzer runZTauMuTauHadAnalyzer
...
runMuMuUndecayedTauETauEAnalyzer: $(OBJLIST) runMuMuUndecayedTauETauEAnalyzer.o
	$(CXX) -o $@ $^ $(ROOTGLIBS)

runMuMuUndecayedTauETauEAnalyzer.o: runMuMuUndecayedTauETauEAnalyzer.cc
	$(CXX) -o $@ -c $< $(CXXFLAGS) $(INCDIR)

runMuMuUndecayedTauMuTauMuAnalyzer: $(OBJLIST) runMuMuUndecayedTauMuTauMuAnalyzer.o
	$(CXX) -o $@ $^ $(ROOTGLIBS)

runMuMuUndecayedTauMuTauMuAnalyzer.o: runMuMuUndecayedTauMuTauMuAnalyzer.cc
	$(CXX) -o $@ -c $< $(CXXFLAGS) $(INCDIR)
