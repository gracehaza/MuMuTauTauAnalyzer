...
int main(int argc, char **argv)
{
    ...
    if (doWhat == "DATA" || doWhat == "ALL")
    {
        ...
        {
            MuMuUndecayedTauETauEAnalyzer DataHist(inputFile, outputDir, 1, 1, maxEvents, false, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
            DataHist.Loop();
            ...
            {
                MuMuUndecayedTauETauEAnalyzer DataHist(fileName, outputDir, 1, 1, maxEvents, false, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
                DataHist.Loop();
    ...
    if (doWhat == "DYJETS" || doWhat == "ALL")
    {
        if (inputFile.EndsWith(".root"))
        {
            ...
            MuMuUndecayedTauETauEAnalyzer DYJetsHist(inputFile, outputDir, lumi*2075.14*3*1000, summedWeights, maxEvents, true, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
            DYJetsHist.Loop();
        } // end if inputFile.EndsWith(".root")
            ...
            while (getline(finTree, fileName))
            {
                MuMuUndecayedTauETauEAnalyzer DYJetsHist(fileName, outputDir, lumi*2075.14*3*1000, summedWeights, maxEvents, true, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
                DYJetsHist.Loop();
    ...
    if (doWhat == "WJETS" || doWhat == "ALL")
    {
        if (inputFile.EndsWith(".root"))
        {
            ...
            MuMuUndecayedTauETauEAnalyzer WJetsHist(inputFile, outputDir, lumi*61526.7*1000, summedWeights, maxEvents, true, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
            WJetsHist.Loop();
        } // end if inputFile.EndsWith(".root")
            ...
            while (getline(finTree, fileName))
            {
                MuMuUndecayedTauETauEAnalyzer WJetsHist(fileName, outputDir, lumi*61526.7*1000, summedWeights, maxEvents, true, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
                WJetsHist.Loop();
            } // end while loop on input file list
        } // end else
    } // end if WJets
    ...
    if (doWhat == "H125AA5" || doWhat == "ALL")
    {
        if (inputFile.EndsWith(".root"))
        {
            ...
            MuMuUndecayedTauETauEAnalyzer H125AA5Hist(inputFile, outputDir, 1, 1, maxEvents, true, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
            H125AA5Hist.Loop();
        } // end if inputFile.EndsWith(".root")
            ...
            while (getline(finTree, fileName))
            {
                MuMuUndecayedTauETauEAnalyzer H125AA5Hist(fileName, outputDir, 1, 1, maxEvents, true, invertedMu2Iso, invertedEle1Iso, Mu2IsoThreshold, Ele1IsoThreshold);
                H125AA5Hist.Loop();
            } // end while loop on input file list
        } // end else 
